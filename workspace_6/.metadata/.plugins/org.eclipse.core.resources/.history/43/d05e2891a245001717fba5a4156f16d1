...
public class MainProgram {
	...
	public static void GamePlaying() {
		...
		cl.run(); // bị sai :v // đánh được
		// while (!cl.timeRun()) { // chạy thời gian // chạy đúng nhưng ko đánh đc
		if (whoFirst == 1) {
	...
	// nComputerWin++;
	// }
	// ScoreText.setText("User " + Integer.toString(nUserWin) + " - " +
	// Integer.toString(nComputerWin) + " Computer");
	//
	// // }
	// }
