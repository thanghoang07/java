...
public class JCanvas extends JComponent implements Printable {
	...
	public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2,
		...
		toBuffer(drawImage8, mkArg(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, bgcolor, observer));
		return true;
	}
	...
	// public void drawString(AttributedCharacterIterator iterator, int x, int
	// y) {
	...
	// Font f=(Font)lookBuffer(setFont);if(f==null)return super.getFont();return
	// f;}
	...
	private void doPaint(Graphics2D g, int s, Object o) {
		...
		case scale1:
			...
			break;
		case setBackground:
			g.setBackground((Color) o); // paintBackground(g,(Color)o);
										// /*super.setBackground((Color)o) ;*/
			break;
		case setComposite:
		...
		case clearRect:
			...
			break;
		case copyArea:
			g.copyArea((Integer) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Integer) o6);
			break;
		case drawArc:
			g.drawArc((Integer) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Integer) o6);
			break;
		case drawBytes:
		...
		case drawImage5:
			...
			break;
		case drawImage6:
			g.drawImage((Image) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Color) o6,
					(ImageObserver) o7);
			break;
		case drawImage7:
			g.drawImage((Image) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (ImageObserver) o6);
			break;
		case drawImage8:
			g.drawImage((Image) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Integer) o6, (Integer) o7,
					(Integer) o8, (Integer) o9, (Color) o10, (ImageObserver) o11);
			break;
		case drawImage9:
			g.drawImage((Image) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Integer) o6, (Integer) o7,
					(Integer) o8, (Integer) o9, (ImageObserver) o10);
			break;
		case drawLine:
		...
		case drawRect:
			...
			break;
		case drawRoundRect:
			g.drawRoundRect((Integer) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Integer) o6);
			break;
		case fillArc:
			g.fillArc((Integer) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Integer) o6);
			break;
		case fillOval:
		...
		case fillRect:
			...
			break;
		case fillRoundRect:
			g.fillRoundRect((Integer) o1, (Integer) o2, (Integer) o3, (Integer) o4, (Integer) o5, (Integer) o6);
			break;
		case setClip1:
			g.setClip((Shape) o);
			break;
		...
		case opaque:
			...
			break;
		case drawOutline: // g.drawString((String)o1, (Integer)o2, (Integer)o3)
							// ;break;
		{
	...
	public static Clip loadClip(String fnm) {
		Clip clip = null;
		try {
			AudioInputStream stream = AudioSystem.getAudioInputStream(new File(fnm));
			...
			if (duration <= 1.0) {
				...
				System.out.println("         The clip in " + fnm + " may not play in J2SE 1.5 -- make it longer");
			}
			// else
