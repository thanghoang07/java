...
public class Bai2 extends GLCanvas implements GLEventListener {
	...
	public void display(GLAutoDrawable drawable) {
		...
		gl.glVertex3f(0.0f, 3.25f, 0.0f); // tọa độ đỉnh 1
		gl.glVertex3f(1.5f, 2.0f, 0.0f); // tọa độ đỉnh 2
		gl.glVertex3f(1.0f, 0.0f, 0.0f); // tọa độ đỉnh 3
		gl.glVertex3f(2.5f, 1.0f, 0.0f); // tọa độ đỉnh 4
		gl.glVertex3f(4.0f, 0.0f, 0.0f); // tọa độ đỉnh 5
		gl.glVertex3f(3.5f, 2.0f, 0.0f); // tọa độ đỉnh 6
		gl.glVertex3f(5.0f, 3.25f, 0.0f); // tọa độ đỉnh7
		gl.glVertex3f(3.15f, 3.25f, 0.0f); // tọa độ đỉnh 8
		gl.glVertex3f(2.5f, 5.25f, 0.0f); // tọa độ đỉnh 9
		gl.glVertex3f(1.85f, 3.25f, 0.0f); // tọa độ đỉnh 10
