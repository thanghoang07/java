...
public class liang_barsky extends JPanel {
	...
	public static int LiangBarsky(int Xmax, int Ymax, int Xmin, int Ymin, int x0, int y0, int x1, int y1,
			Graphics g2d) {
	...
	public static void bresenham_line(Dimension p1, Dimension p2, Graphics g2d) {
		...
		int y1 = (int) p2.getHeight(), y0 = (int) p1.getHeight(), x1 = (int) p2.getWidth(), x0 = (int) p1.getWidth(),
				dx = x1 - x0, dy = y1 - y0, y = y0, x = x0, incE, incNE, d, stepx, stepy;
	...
	public static void main(String[] args) {
		...
		int x = Integer.parseInt(JOptionPane
				.showInputDialog("Ingrese el incremento en X y Y " + " este debe ser un numero entre 0-100"));
		setskip(x);
		frame.add(new liang_barsky());
