                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Nguyên liệu
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>36</td>
										<td>G001, Gỗ mít</td>
										<td>NCC001, MIs, 01622333444, Pleiku - Gia Lai, mis@gmail.com</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Inox</td>
                                        <td>122</td>
										<td>INX001, INox bạc</td>
										<td>NCC002, INox, 01622333909, Dĩ An - Bình Dương, inoxbac@gmail.com</td>
										<!-- <td>Co.ltd Group 12 MIS </td> -->
                                    </tr>
                                    <tr>
										<td><input type="checkbox" value=""></td>
