        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="forms.jsp"><i class="fa fa-fw fa-table"></i> Khách hàng</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="quan-ly-sp-ban.jsp">Sản phẩm BÀN</a>
                            </li>
                            <li>
                                <a href="quan-ly-sp-ghe.jsp">Sản phẩm GHẾ</a>
                            </li>
                            <li>
                                <a href="quan-ly-sp-tu.jsp">Sản phẩm TỦ</a>
                            </li>
                            <li>
                                <a href="them-sp.jsp">Thêm sản phẩm mới</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="demo1" class="collapse">
                            <li>
                                <a href="quan-ly-ns-nhanvien.jsp">Nhân viên</a>
                            </li>
                            <li>
                                <a href="quan-ly-ns-kho.jsp">Kho</a>
                            </li>
                            <li>
                                <a href="quan-ly-ns-quanly.jsp">Quản lý</a>
                            </li>
                        </ul>
                    </li>
                    <li>
