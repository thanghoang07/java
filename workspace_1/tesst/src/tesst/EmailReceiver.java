...
public class EmailReceiver {
	...
	public void downloadEmails(String protocol, String host, String port, String userName, String password) {
		...
		try {
			...
			for (int i = 0; i < messages.length; i++) {
				...
				String messageContent = "AAAAAAAAAAAAAAA";
	...
	public static void main(String[] args) {
		// for POP3
		/*
		 * String protocol = "pop3"; String host = "pop.gmail.com"; String port
		 * = "995";
		 */
		...
		String userName = "toan.spro@gmail.com";
		String password = "spro@123";
