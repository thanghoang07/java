...
public abstract class MaTran_lab2_ctdl_hkI_2015<T extends Number> 
{
	  protected abstract T congLai(T o1, T o2);
	  protected abstract T nhanVao(T o1, T o2);
	  protected abstract T zero();

	  //cong ma tran
	  public T[][] congHaiMaTran(T[][] matran1, T[][] matran2)
	  {	    
	    if ((matran1.length != matran2.length) ||
	        (matran1[0].length != matran2[0].length));

	    T[][] ketQua1 =
	      (T[][])new Number[matran1.length][matran1[0].length];
	  ...
	  //nhan ma tran
	  public T[][] nhanHaiMaTran(T[][] matran1, T[][] matran2)
	  {	   
	    if (matran1[0].length != matran2.length);

	    T[][] ketQua2 =
	      (T[][])new Number[matran1.length][matran2[0].length];
