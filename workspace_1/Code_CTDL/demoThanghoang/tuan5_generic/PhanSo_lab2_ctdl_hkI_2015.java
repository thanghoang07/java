...
public class PhanSo_lab2_ctdl_hkI_2015 extends Number
{
	int tuSo, mauSo;
	...
	public PhanSo_lab2_ctdl_hkI_2015()
	{
		this.tuSo = 0;
		this.mauSo = 0;
	}
	...
	public PhanSo_lab2_ctdl_hkI_2015(int a, int b)
	{
	...
	//tinh
	//cong
	public PhanSo_lab2_ctdl_hkI_2015 congHaiPhanSo(PhanSo_lab2_ctdl_hkI_2015 b)
	{
		PhanSo_lab2_ctdl_hkI_2015 a = this;
		return new PhanSo_lab2_ctdl_hkI_2015((a.tuSo * b.mauSo) 
						+ (a.mauSo * b.tuSo), a.mauSo * b.mauSo); 
	}
	
	//nhan
	public PhanSo_lab2_ctdl_hkI_2015 nhanHaiPhanSo(PhanSo_lab2_ctdl_hkI_2015 b)
	{
		PhanSo_lab2_ctdl_hkI_2015 a = this;
		return new PhanSo_lab2_ctdl_hkI_2015(a.tuSo * b.tuSo, a.mauSo * b.mauSo);		
	}
	...
	public static void main(String[] args)
	{
		...
		PhanSo_lab2_ctdl_hkI_2015 x, y, z, t, g, m;
		
		x = new PhanSo_lab2_ctdl_hkI_2015(soA, soB);
		y = new PhanSo_lab2_ctdl_hkI_2015(soC, soD);
