...
class GUI extends Panel {
	 ...
	 */
	GUI(SimOperatorPanel operatorPanel, SimCardReader cardReader, SimDisplay display, SimKeyboard keyboard,
			SimCashDispenser cashDispenser, SimEnvelopeAcceptor envelopeAcceptor, SimReceiptPrinter receiptPrinter) {
		...
		atmPanel = new ATMPanel(this, operatorPanel, cardReader, display, keyboard, cashDispenser, envelopeAcceptor,
				receiptPrinter);
	...
	/**
	 * Simulate getting the amount of cash in the cash dispenser from the
	...
	/**
	 * Create a GridBagConstraints object with specified constraints, and others
	 * defaulted.
	 *
	 * @param row
