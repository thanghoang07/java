...
public class SimpleDigitalClock extends JPanel {
	...
	public SimpleDigitalClock() {
		...
		/*
		 * Loop that will make sure panel show current time like current second,
		 * current minute and current hour.
		 */
		while (true) {
	...
	public void paint(Graphics g) {
		...
		/*
		 * Create current Date object. It means it store information about
