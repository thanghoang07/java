...
public class StudenManagement extends JFrame implements ActionListener, KeyListener {
	/**
	 * 
	 */
	...
	public void upDataTen() {
		// ho ten
		lblNgay2.setText(jtfHoTen.getText());
	}

	public void upDataMSV() {
		// msv
		lblNgay2.setText(jtfMSV.getText());
	}

	public void upDaTaGiangVien() {
		// giang vien
		lblNgay2.setText(jtfGiangVien.getText());
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		jtfHienNgayDayDu.setText("Ho Ten: " + jtfHoTen.getText() + "\n Ngay Sinh: " + String.valueOf(ngayChon) + " - "
				+ String.valueOf(thangChon) + " - " + String.valueOf(namChon) + "\n MSV: " + jtfMSV.getText()
