...
public class Tree {
	...
	public UndirectedGraph DFSTree(int vex) {
	...
	public UndirectedGraph BFSTree(int vex, UndirectedGraph graph) {
		// khỏi tạo một queue
